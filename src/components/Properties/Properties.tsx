...
import { LiaBedSolid, LiaBathSolid, LiaStarSolid, LiaRulerCombinedSolid } from 'react-icons/lia'
        ...
        <Transition className="px-4 py-8 md:py-32 md:px-40 ">
            ...
            <div className="text-center my-7">
                {counterHouses < dataProperties.length && (
                    <button className="px-6 py-5 text-white transition-all duration-150 cursor-pointer bg-secondary rounded-xl hover:bg-black" onClick={loadMoreHouses}>
                        Ver más viviendas
                    </button>
                )}
            </div>
